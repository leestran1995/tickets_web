...
public class Backend {
     ...
     * <p>
     *     Save a ticket array to a file so we can access it later.
     * </p>
     * @param outputPath Path to save the file to, generated by a higher-level method
     * @param ticketArray The array of tickets to be saved to the file
     * @return true if the file was created successfully, false otherwise.
     *
     */
    private static boolean saveTicketArrayToFile(String outputPath, Ticket[] ticketArray) {
        try {
    ...
    /**
     * Read a ticket array from a file.
     ...
     */
    private static Ticket[] readTicketFile(String username, String eventName) {
        try {
